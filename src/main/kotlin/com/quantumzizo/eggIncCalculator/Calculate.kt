...
fun soulEggCalculate(prestEarnings:Double, eventBoost:Double): Double {
    var z:Double = prestEarnings * eventBoost * (max(0.0,(10.0.pow(-6) * min(prestEarnings, 10.0.pow(12)))).pow(0.15) - (10.0.pow(-6).pow(0.15))
